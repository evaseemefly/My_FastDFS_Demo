...
namespace FastDFS.Client
{
    ...
    public class FastDFSClient
    {
        ...
        /// 拼接url
        /// </summary>
        /// <param name="host">storage地址</param>
        /// <param name="group">群租名称</param>
        /// <param name="shortName">文件名称</param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        public static string GetShortNameFormUrl(string host,string url,string group)
        {
